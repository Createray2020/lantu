...
describe("章節：每一個分類的結果都在報告書裡", () => {
  const WANT = [
    ...
    // 2026/08/29 D2：新增「產險比對」一章（住宅火險＋地震／第三人責任／車體／雇主·公共意外）。
    // 專案規則「輸入完會產生結果的都要放出來」，示範案有自住房 → 這一章一定會出現。
    "退休與教育需求", "風險保障缺口", "產險比對（住宅・車輛・責任）", "保單檢查報告", "現金流投影與機率", "稅賦分析",
    "傳承規劃", "投資風險屬性與建議配置", "其他規劃面向", "規劃前 / 後對照",
    "真實追蹤與人生護照", "規劃執行建議", "執行行動清單", "動態調整（PDCA）", "注意事項",
  ];
  it("資料齊全時，二十章一個都不少、順序固定", () => {
